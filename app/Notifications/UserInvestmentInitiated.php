...
class UserInvestmentInitiated extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject("You Have Initiated an Investment on MoreBitcoin 😃")
            ->markdown('mail.user.investment.initiated', ['firstname' => $firstname, 'investment' => $investment, 'data' => $data]);
    }
