...
class AdminInvestmentCompleted extends Notification
{
    use Queueable;
    ...
    {
        Log::info("Admin Investment Completed: Mail Sent to Admin");
        ...
        return (new MailMessage)
            ->subject("Investment Matured on MoreBitcoin 😃")
            ->markdown('mail.admin.investment.completed', ['user' => $user, 'investment' => $investment, 'data' => $data]);
    }
