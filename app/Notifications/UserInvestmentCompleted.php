...
class UserInvestmentCompleted extends Notification
{
    use Queueable;
    ...
    {
        Log::info("User Investment Completed: Mail Sent to " . $this->user->profile->first_name . " " . $this->user->profile->last_name . " (" . $this->user->email . ")");
        ...
        return (new MailMessage)
            ->subject("You have a matured Investment on MoreBitcoin 😃")
            ->markdown('mail.user.investment.completed', ['firstname' => $firstname, 'investment' => $investment, 'data' => $data]);
    }
